...
export default function Philosophie() {
    ...
    return (
        <div className="relative bg-slate-950 min-h-screen font-sans text-gray-200 overflow-hidden selection:bg-emerald-500/30">
            
            <motion.div 
                animate={{ rotate: 360 }}
                transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
                className="fixed top-[-50%] left-[-50%] w-[200%] h-[200%] pointer-events-none z-0"
                style={{ background: 'radial-gradient(circle, rgba(16, 185, 129, 0.03) 0%, transparent 40%)' }}
            />

            <header className="fixed top-4 sm:top-6 left-1/2 -translate-x-1/2 w-[95%] max-w-6xl z-50">
                <div className="bg-slate-950/60 backdrop-blur-2xl border border-emerald-500/20 rounded-full px-6 py-3 flex justify-between items-center shadow-[0_0_30px_rgba(16,185,129,0.15)]">
                    ...
                    <Link to="/contact" className="px-6 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/50 text-emerald-400 hover:bg-emerald-500 hover:text-slate-900 font-bold text-sm uppercase tracking-widest transition-all duration-300">
                        Kontakt
                    </Link>
                </div>
            </header>

            <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 py-20 space-y-20">
                ...
                >
                    <h1 className="text-4xl md:text-7xl font-bold text-white mb-6 mt-2 tracking-tight drop-shadow-lg">
                        Qualitäts<span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-green-500">philosophie</span>
                    </h1>
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <motion.div 
                        ...
                        className="bg-slate-900/40 backdrop-blur-md border border-white/5 rounded-3xl p-8 sm:p-10 hover:border-red-500/30 transition-colors"
                    >
                    ...
                    <motion.div 
                        ...
                        className="bg-slate-900/60 backdrop-blur-md border border-emerald-500/30 rounded-3xl p-8 sm:p-10 shadow-[0_0_30px_rgba(16,185,129,0.1)] relative overflow-hidden"
                    >
                        <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-500/10 blur-3xl rounded-full"></div>
                        <h3 className="text-2xl font-bold text-emerald-400 mb-4 relative z-10">Unsere Antwort</h3>
                ...
                <section className="flex flex-col md:flex-row items-center gap-12">
                    ...
                    >
                        ...
                        <blockquote className="border-l-4 border-emerald-500 pl-6 py-2 italic text-xl text-gray-200">
                        ...
                        <table className="w-full min-w-[600px] text-left border-collapse">
                            <thead>
                                <tr className="bg-emerald-500/10 border-b border-emerald-500/20">
                                    <th className="p-4 sm:p-6 text-emerald-400 font-bold uppercase tracking-wider whitespace-nowrap">Service-Merkmal</th>
                                    <th className="p-4 sm:p-6 text-gray-400 font-semibold uppercase tracking-wider whitespace-nowrap">Standard-Firma</th>
                                    <th className="p-4 sm:p-6 text-white font-bold uppercase tracking-wider whitespace-nowrap">Arasim & Kedzierski</th>
                                </tr>
                            </thead>
                            <tbody className="text-gray-300 font-light text-sm sm:text-base">
                                <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                    <td className="p-4 sm:p-6 font-medium whitespace-nowrap">Kommunikation</td>
                                    <td className="p-4 sm:p-6">Hotline / Formulare</td>
                                    <td className="p-4 sm:p-6 text-emerald-300 font-medium">Direkt zum Chef</td>
                                </tr>
                                <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                    <td className="p-4 sm:p-6 font-medium whitespace-nowrap">Qualitätskontrolle</td>
                                    <td className="p-4 sm:p-6">Stichprobenartig</td>
                                    <td className="p-4 sm:p-6 text-emerald-300 font-medium">Kontinuierlich, durch Inhaber</td>
                                </tr>
                                <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                    <td className="p-4 sm:p-6 font-medium whitespace-nowrap">Reaktionszeit</td>
                                    <td className="p-4 sm:p-6">48-72 Stunden</td>
                                    <td className="p-4 sm:p-6 text-emerald-300 font-medium">Meist innerhalb von 24h</td>
                                </tr>
                                <tr className="hover:bg-white/5 transition-colors">
                                    <td className="p-4 sm:p-6 font-medium whitespace-nowrap">Verantwortung</td>
                                    <td className="p-4 sm:p-6">Verteilt / Unklar</td>
                                    <td className="p-4 sm:p-6 text-emerald-300 font-bold">Persönlich (Unser Name)</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <motion.section 
                    ...
                    className="text-center bg-gradient-to-br from-slate-900 to-slate-950 border border-emerald-500/30 rounded-3xl p-8 sm:p-12 shadow-[0_0_40px_rgba(16,185,129,0.15)]"
                >
                    ...
                    >
                        <Link to="/contact" className="inline-block px-10 py-4 rounded-full bg-emerald-500 text-slate-950 font-bold tracking-widest uppercase hover:bg-emerald-400 shadow-[0_0_20px_rgba(16,185,129,0.5)] transition-colors duration-300">
