                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-4 mt-8">
                            <a href="tel:+491621940328" className="flex items-center gap-6 p-6 rounded-3xl bg-slate-900/40 border border-white/5 hover:border-emerald-500/30 hover:bg-white/5 transition-all duration-300 group">
                                <div className="p-4 rounded-full bg-emerald-500/10 text-emerald-400 group-hover:scale-110 group-hover:bg-emerald-500 group-hover:text-slate-950 transition-all duration-300">
                                ...
                                <div>
                                    ...
                                    <p className="text-xl text-white font-medium group-hover:text-emerald-400 transition-colors">+49 162 1940328</p>
                                </div>
                            </a>

                            <a href="mailto:info@akgebaeudeservice.com" className="flex items-center gap-6 p-6 rounded-3xl bg-slate-900/40 border border-white/5 hover:border-emerald-500/30 hover:bg-white/5 transition-all duration-300 group">
                                <div className="p-4 rounded-full bg-emerald-500/10 text-emerald-400 group-hover:scale-110 group-hover:bg-emerald-500 group-hover:text-slate-950 transition-all duration-300">
                                ...
                                <div className="overflow-hidden">
                                    ...
                                    <p className="text-lg sm:text-xl text-white font-medium group-hover:text-emerald-400 transition-colors truncate">info@akgebaeudeservice.com</p>
                                </div>
                            </a>
                        </div>
                    </motion.div>
                        ...
                        <form onSubmit={handleSubmit} className="relative z-10 flex flex-col space-y-5">
                            ...
                            <div className="w-full">
                                ...
                                `}>
                                    ...
                                    <span className="text-gray-400 font-medium group-hover:text-emerald-400 transition-colors">Dateien hinzufügen (Bilder, PDFs...)</span>
